...
class Serenity
{
  ...
  {
    return app()->singleton(CreatesTeamsInterface::class, $class);
  }
  ...
  {
    return app()->singleton(UpdatesTeamNamesInterface::class, $class);
  }
  ...
  {
    return app()->singleton(AddsTeamMembersInterface::class, $class);
  }
  ...
  {
    return app()->singleton(InvitesTeamMembersInterface::class, $class);
  }
  ...
  {
    return app()->singleton(RemovesTeamMembersInterface::class, $class);
  }
  ...
  {
    return app()->singleton(DeletesTeamsInterface::class, $class);
  }
  ...
  {
    return app()->singleton(DeletesUsersInterface::class, $class);
  }
  ...
  {
    app()->singleton(LoginViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(TwoFactorChallengeViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(ResetPasswordViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(RegisterViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(VerifyEmailViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(ConfirmPasswordViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(RequestPasswordResetLinkViewInterface::class, function () use ($view) {
      return new SimpleViewResponder($view);
    });
  }
  ...
  {
    app()->singleton(CreatesNewUsersInterface::class, $callback);
  }
  ...
  {
    app()->singleton(UpdatesUserProfileInformationInterface::class, $callback);
  }
  ...
  {
    app()->singleton(UpdatesUserPasswordsInterface::class, $callback);
  }
  ...
  {
    app()->singleton(ResetsUserPasswordsInterface::class, $callback);
  }

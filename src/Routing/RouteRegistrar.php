...
use Serenity\Routing\PendingRoutes\PendingRouteFactory;
use Serenity\Routing\PendingRouteTransformers\PendingRouteTransformer;
use SplFileInfo;
...
class RouteRegistrar
{
   ...
   * @return Collection<\Serenity\Routing\PendingRoutes\PendingRoute>
   */
  ...
  protected function transformPendingRoutes(Collection $pendingRoutes): Collection
  {
    ...
    $transformers = config('serenity.pending_route_transformers');

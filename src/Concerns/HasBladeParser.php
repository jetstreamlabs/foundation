...
trait HasBladeParser
{
  ...
  {
    return preg_replace(
      config('docs.blade-parser.regex.code-blocks.match'),
      config('docs.blade-parser.regex.code-blocks.replacement'),
      $content
    );
  }
  ...
  {
    $replacement = config('docs.blade-parser.regex.code-blocks.replacement');
  ...
  {
    $pattern = config('docs.blade-parser.regex.code-blocks.match');
